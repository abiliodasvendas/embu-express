          ...
          <div className="animate-in fade-in duration-500 space-y-8">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 mt-8">
              <TabsList className="flex w-full justify-start overflow-x-auto lg:w-max h-12 rounded-2xl bg-gray-100 p-1 no-scrollbar scroll-smooth whitespace-nowrap">
                ...
                <TabsTrigger value="convenios" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-sm gap-2 shrink-0 px-4 font-bold text-gray-600 data-[state=active]:text-emerald-700">
              ...
              <TabsContent value="turnos" className="space-y-6 mt-0 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {extrato.resumo_por_cliente && extrato.resumo_por_cliente.length > 0 ? (
                  ...
                  <div className="h-full min-h-[250px] flex flex-col items-center justify-center text-center bg-gray-50/50 rounded-[2.5rem] p-10 border border-dashed border-gray-200">
                    ...
                    <h3 className="text-lg font-black text-gray-700 mb-2">Turnos</h3>
                    <p className="text-xs text-gray-400 font-medium max-w-[250px] leading-relaxed">
                      Nenhum turno vinculado ao colaborador.
                    </p>
                  </div>
                )}
              </TabsContent>
              ...
              <TabsContent value="avulsos" className="space-y-6 mt-0 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                {(extrato.totais?.total_mei > 0 ||
                  ...
                  <div className="h-full min-h-[250px] flex flex-col items-center justify-center text-center bg-gray-50/50 rounded-[2.5rem] p-10 border border-dashed border-gray-200">
                    ...
                    <h3 className="text-lg font-black text-gray-700 mb-2">Avulsos</h3>
                    <p className="text-xs text-gray-400 font-medium max-w-[250px] leading-relaxed">
                ...
                {extrato.lancamentos_convenios && extrato.lancamentos_convenios.length > 0 ? (
                  <Card className="border-none shadow-lg rounded-[2.5rem] overflow-hidden bg-white border border-gray-100 transition-all hover:shadow-xl group">
                    <CardContent className="p-6 md:p-10">
                      <div className="space-y-4">
                        {extrato.lancamentos_convenios.map((lancamento, idx) => (
                          <div
                            key={idx}
                          ...
                          >
                            <div className="flex items-start sm:items-center gap-4 flex-1">
                              <div className="h-10 w-10 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover/occ:scale-110 bg-red-50 text-red-600">
                                <ArrowDownCircle className="h-5 w-5" />
                              </div>
                              <div>
                                <p className="text-sm font-black text-gray-800 tracking-tight">
                                  {lancamento.convenio?.nome || "Convênio"}
                                </p>
                                {lancamento.descricao && (
                                  <p className="text-[11px] text-gray-500 italic font-medium leading-tight sm:max-w-[300px] mt-0.5">
                                    {lancamento.descricao}
                                  </p>
                                )}
                                <p className="text-[10px] text-gray-400 font-bold uppercase">
                                  {format(
                                    new Date(lancamento.data_lancamento + "T12:00:00"),
                                    "PPP",
                                    { locale: ptBR },
                                  )}
                                </p>
                            ...
                            <span className="text-sm font-black self-end sm:self-center bg-white sm:bg-transparent px-3 py-1 sm:p-0 rounded-lg shadow-sm sm:shadow-none text-red-500">
                        ...
                        <div className="pt-4 border-t border-gray-100 mt-2">
                          <div className="flex items-center justify-between px-2">
                            <span className="text-xs text-gray-400 font-bold uppercase tracking-widest">
                              Total Descontos Convênios
                            </span>
                            <p className="text-lg font-black text-red-600">
                              - {formatCurrency(
                                extrato.lancamentos_convenios.reduce((acc, l) => acc + Number(l.valor), 0)
                              )}
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="h-full min-h-[250px] flex flex-col items-center justify-center text-center bg-gray-50/50 rounded-[2.5rem] p-10 border border-dashed border-gray-200">
                    ...
                    <h3 className="text-lg font-black text-gray-700 mb-2">Convênios</h3>
                    <p className="text-xs text-gray-400 font-medium max-w-[250px] leading-relaxed">
