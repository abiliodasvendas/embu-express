...
export interface RelatorioPonto extends RegistroPonto {
  colaborador_nome?: string;
  colaborador_cpf?: string;
  cliente_nome?: string;
  total_pausas_minutos?: number;
  tempo_trabalhado_minutos?: number;
  qtd_pausas?: number;
  total_km_trabalho?: number;
  total_km_pausa?: number;
  turno_hora_inicio?: string;
  turno_hora_fim?: string;
}

// Alias for convenience
export type Ponto = RegistroPonto;
