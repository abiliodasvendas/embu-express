import { Users, Clock, PlayCircle, LogOut, AlertTriangle, Timer } from "lucide-react";
...
export const PONTO_STATUS_UI_CONFIG: Record<ManagementStatus, PontoStatusConfig> = {
  ...
  [ManagementStatus.OVERTIME]: { label: "Hora Extra", color: "text-sky-600", bg: "bg-sky-50", border: "border-sky-400", borderSide: "bg-sky-500", icon: Timer },
  ...
  [ManagementStatus.ABSENT]: { label: "Sem Atividade", color: "text-rose-600", bg: "bg-rose-50", border: "border-rose-500", borderSide: "bg-rose-500", icon: AlertTriangle },
};
