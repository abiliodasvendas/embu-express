...
export const LayoutProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <LayoutContext.Provider value={{
      ...
      {occurrenceFormDialogState.open && <OccurrenceFormDialog open={true} onOpenChange={(open) => !open && closeOccurrenceFormDialog()} collaboratorId={occurrenceFormDialogState.props?.collaboratorId} defaultValues={occurrenceFormDialogState.props?.defaultValues} onSuccess={() => { occurrenceFormDialogState.props?.onSuccess?.(); closeOccurrenceFormDialog(); }} />}
