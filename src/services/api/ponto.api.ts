...
export const pontoApi = {
  ...
  toggle: (data: { usuario_id: string; data_referencia?: string; hora?: string; km?: number; location?: any; cliente_id?: number; empresa_id?: number; colaborador_cliente_id?: number }): Promise<any> =>
